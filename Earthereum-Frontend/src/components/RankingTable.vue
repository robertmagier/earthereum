...
<center>
    <h4 style="color:#ddd"> Top Players </h4>
    <b-table :per-page="perPageRanking" :fields="rankingFields" striped hover :currentPage="currentPageRanking" class="informationtable" :items="ranking" style="width:100%;"></b-table>
</center>
